...
while(exit==0)
  ...
  switch mode 
      ...
      case(1)%walk mode
    if(strcmp(key_down,'rightarrow')==1 && guy_y<max_dim)
        guyground(guy_x,guy_y)=1;
        guy_y=guy_y+1;
        guyground(guy_x,guy_y)=blue_guy_pos;
    elseif(strcmp(key_down,'leftarrow')==1 && guy_y>1)
        guyground(guy_x,guy_y)=1;
        guy_y=guy_y-1;
        guyground(guy_x,guy_y)=blue_guy_pos;
    elseif(strcmp(key_down,'uparrow')==1 && guy_x>1)
        guyground(guy_x,guy_y)=1;
        guy_x=guy_x-1;
        guyground(guy_x,guy_y)=blue_guy_pos;
    elseif(strcmp(key_down,'downarrow')==1 && guy_x<max_dim)
        guyground(guy_x,guy_y)=1;
        guy_x=guy_x+1;
       guyground(guy_x,guy_y)=blue_guy_pos;
    elseif(strcmp(key_down,'r')==1)
      ...
      case(0)%portal mode
    if(strcmp(key_down,'rightarrow')==1 && port_y<max_dim)
       portground(port_y,port_x)=1;
        port_x=port_x+1;
        portground(port_y,port_x)=port_pos;
    elseif(strcmp(key_down,'leftarrow')==1 && port_y>1)
       portground(port_y,port_x)=1;
        port_x=port_x-1;
        portground(port_y,port_x)=port_pos;
    elseif(strcmp(key_down,'uparrow')==1 && port_x>1)
        portground(port_y,port_x)=1;
        port_y = port_y-1;
      portground(port_y,port_x)=port_pos;
    elseif(strcmp(key_down,'downarrow')==1 && port_x<max_dim)
         portground(port_y,port_x)=1;
        port_y = port_y+1;
       portground(port_y,port_x)=port_pos;
