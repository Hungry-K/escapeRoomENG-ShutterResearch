close all;
clear;
Joystick_arduino = arduino('COM12','Uno');
%set values for pins
xPin= 'A0';
yPin= 'A1';
swPin= 'A2';
...
while(in_door==0)
    ...
    case(1)
        %Right
        if(xvalue>3 && wizard_c<max_dim && foreground(wizard_r,wizard_c+1) ~= 19)
        ...
        %Left
        elseif(xvalue<2 && wizard_c>1 && foreground(wizard_r,wizard_c-1) ~= 19)
